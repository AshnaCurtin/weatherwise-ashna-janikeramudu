...
starter_notebook.ipynb 		-- Your main Colab notebook (full working code) 	-- Download from Colab (template is on Blackboard)
app.ipynb 		            -- Your main Colab notebook (full working code) 	-- Download from Colab (template is on Blackboard)
README.md 					-- Instructions for running the app                 -- Create manually on your PC
reflection.txt 				-- 300–500 word reflection on your project          -- Create manually on your PC
